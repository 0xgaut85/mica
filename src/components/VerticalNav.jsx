  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-4">
        <motion.a
          href="https://clanker.world/clanker/0x7eEcF9E0D389A4C7688fe1CFEa749f2016c9Eb07"
          target="_blank"
          ...
          aria-label="View $MICA on Clanker"
        >
        ...
        >
          <img src="/coingecko.png" alt="CoinGecko" className="w-[18px] h-[18px] object-contain" />
        </motion.a>
        <motion.a
          href="#"
          target="_blank"
        ...
        >
          <img src="/coinmarketcap.jpeg" alt="CoinMarketCap" className="w-[18px] h-[18px] object-contain" />
        </motion.a>
        <motion.a
